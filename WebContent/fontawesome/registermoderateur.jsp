...
<html>
<head>
	<title>registermoderateur</title>
	<meta charset="utf-8">
		    ...
		    <div class="col-lg-6">
		    	<section id="couleur1">
		    		<div class="bg-primary">
			    		<h4 class="connect pt-2 pb-3">Inscription Moderateur</h4>
			    	</div> 
			    	<form action="#" method="post" class="was-validated">

				    	<fieldset class="form-group ml-2">
						    <div class="row">
						      	<legend class="col-form-label col-sm-3 pt-0">Civilité</legend>
						      	<div class="col-sm-9">
						...
						<div class="form-group row">
						    ...
						    <div class="col-sm-9">
						      ...
						      <div class="valid-feedback ml-2">ok</div> <!-- ces deux div permet de dire que si le champ est valide ou pas-->
						      <div class="invalid-feedback ml-2">pas ok</div>
						    </div>
				  		</div>
				  		...
				  		<div class="form-group row">
						    <label for="phone" class="col-sm-2 col-form-label">Numéro</label>
						    <div class="col-sm-10">
						    ...
						    <div class="col-sm-10">
						      <div class="form-check">
						        ...
						        <label class="form-check-label" for="accord">
						          <a target="_blank" href="cgu.jsp">J'accepte les CGU</a>
						        </label>
						      </div>
						    </div>
				  		</div>
